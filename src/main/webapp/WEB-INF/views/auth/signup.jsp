...
<body>
	...
	<div class="container-fluid d-flex justify-content-center">
		<form id="joinForm" name="joinForm" action="/javajavajo_mini_web/" method="post"
			...
			<input type="text" class="form-control w-100" id="uid"
				placeholder="아이디 (필수)" name="uidPattern" required>
			<div class="my-2 ms-2">
				<span id="uidSpan" class="form-text" style="font-size: 11px;">영문자,숫자만
					입력가능 최소 3자이상 입력해주세요. </span>
			</div>
			<div class="my-2">
				<input type="password" class="form-control w-100" id="password"
					placeholder="비밀번호 (필수)" name="passwordPattern" required>
				<div class="mx-2 mt-2">
					<span id="passwordSpan" class="form-text" style="font-size: 11px;">대,
						소문자를 포함한 8자이상 15자이하 입력해주세요.</span>
				</div>
			</div>
			<input type="password" class="form-control w-100" id="passwordRe"
				placeholder="비밀번호확인 (필수)" name="passwordRePattern" required>
			<div class="mx-2 mt-2">
				<span id="passwordReSpan" class="form-text" style="font-size: 11px;">대,
					소문자를 포함한 8자이상 15자이하 입력해주세요.</span>
			</div>
			<div class="pt-5">
				<h5>개인정보 입력</h5>
			</div>
			<input type="text" class="form-control w-100" id="uname"
				placeholder="이름 (필수)" name="uname" required>
			<div class="p-2">
				<span id="unameSpan" class="form-text" style="font-size: 11px;">공백없이
					한글,영문,숫자만 입력가능(한글2자, 영문 4자 이상)</span>
			</div>
			<div class="mb-3 my-2">
				<input type="text" class="form-control w-100" id="unickname"
					placeholder="닉네임 (필수)" name="unickname" required>
				<div class="mx-2 mt-2">
					<span id="unicknameSpan" class="form-text" style="font-size: 11px;">닉네임
						첫 글자는 대문자로 시작하며 3자이상 8자이하로 작성해주세요.</span>
				</div>
			</div>
			<div class="mb-3">
				<input type="email" class="form-control w-100" id="uemail"
					placeholder="Email (필수)" name="uemail" required>
				<div class="mx-2 mt-2">
					<span id="uemailSpan" class="form-text" style="font-size: 11px;">이메일
						형식에 맞춰 입력해주세요.</span>
				</div>
			</div>

			<input type="text" class="form-control w-100" id="uphoneNum"
				placeholder="휴대폰번호 (필수)" name="uphoneNum" required>
			<div class="mx-2">
				<span id="uphoneNumSpan" class="form-text" style="font-size: 11px;">휴대폰
					번호를 입력해주세요.</span>
			</div>
			...
			<div class="mb-3">
				<input type="text" class="form-control w-100" id="upostalCode"
					placeholder="우편번호 (필수)" name="upostalCode" required>
				<div class="mx-2">
			...
			<div class="mb-3">
				<input type="text" class="form-control w-100" id="uadress"
					placeholder="주소 (필수)" name="uadress" required>
				<div class="mx-2">
