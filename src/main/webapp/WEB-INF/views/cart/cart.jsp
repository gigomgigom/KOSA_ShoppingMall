...
<body>
	...
	<div id="shoppingcart" style="min-width: 1250px"
		...
		<div
			class="w-75  d-flex justify-content-start align-items-center m-1 p-0">
			<input id="allCheck" onclick="allCheck()" class="m-0 p-0"
				type="checkbox" style="accent-color: #273740D;"> <label
			...
			<c:forEach var="cartItem" items="${cartItems}">
				<li id="item${cartItem.prodno}"
					...
					<div class="col-2 row border-end m-0 p-0">
						<div
							class="form-check col-2 d-flex justify-content-start align-items-center m-0 p-0">
							<input onclick="cancelAllCheck()" class="m-0" type="checkbox"
								style="accent-color: #27374D;">
						</div>
						<div
					...
					<div class="col-3 row d-flex align-items-center border-end m-0 p-0">
						<div class="col-5 d-flex justify-content-end p-0">
							<button onclick="updateItemData(${cartItem.prodno},'-')"
								type="button" class="btn m-1 p-2 text-white"
								style="background-color: #273740">-</button>
						</div>
					...
					<div
						...
						<div class="w-75 text-white text-center"
		...
		<div class="w-75 d-flex justify-content-start align-items-center m-1">
			<button onclick="deleteSelect()" type="button"
				class="btn text-white p-0" style="background-color: #273740">선택
				삭제</button>
		</div>
