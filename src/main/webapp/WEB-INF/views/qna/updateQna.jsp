		...
		<div class="row w-50 border-bottom m-0 p-0">
			...
			<div
				...
				<c:if test="${qna.qnaattachoname != null }">
					<div class="d-flex justify-content-between align-items-center w-75 m-0 p-0" id="existAttach">
						<p><a class="text-dark"
								href="${pageContext.request.contextPath}/qna/downloadQnaAttach?qnano=${qna.qnano}">${qna.qnaattachoname}</a></p>
						<p><a onclick="deleteAttach()">&#10060;</a></p>
					</div>
				</c:if>
