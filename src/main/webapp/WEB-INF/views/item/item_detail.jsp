                    ...
                    <div class="w-50 p-3 d-flex flex-column">
                        <div class="d-flex flex-column py-5">
                            ...
                            <div class="d-flex flex-column border-bottom">
                                ...
                                <span>구매후기 n건 | ⭐⭐⭐⭐</span>
                                <span class="mt-4 fw-bold">소비자가 40,000원</span>
                                <span class="mt-2" style="font-size: 0.75rem;">배송비 3,000원 (주문시 결제) - CJ 대한통운</span>
                                <span class="mb-3" style="font-size: 0.75em;">제주 추가 3,000원, 제주 외 도서지역 추가 7,000원</span>
                            </div>
                            <!--  -->
                            <div class="mt-4 px-5 d-flex justify-content-between">
                                <span class="fw-bold">수량</span>

                                <input type="number" value="0" style="text-align: center;">
                            </div>

                            <div class="mt-3 d-flex justify-content-between">
                                <button class="btn btn-lg border fw-bold" style="background-color: #9DB2BF;">장바구니</button>
                                <button class="btn btn-lg text-white fw-bold w-50"  style="background-color: #27374D;">바로구매</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="border-top container" style="background-color: #9DB2BF;">
            <nav class="navbar justify-content-center">
                <ul class="nav justify-content-center me-5">
                    <li class="nav-item active" id="nav-1">
                        <a class="btn fw-bold text-white" onclick="handleBtnShow(1)">상품정보</a>
                    </li>
                    <li class="nav-item" id="nav-2">
                        <a class="btn fw-bold text-white" onclick="handleBtnShow(2)">구매후기</a>
                    </li>
                    <li class="nav-item" id="nav-3">
                        <a class="btn fw-bold text-white" onclick="handleBtnShow(3)">상품문의</a>
                    </li>
                    <li class="nav-item" id="nav-4">
                        <a class="btn fw-bold text-white" onclick="handleBtnShow(4)">배송정보</a>
                    </li>
                </ul>
            </nav>
        </div>
